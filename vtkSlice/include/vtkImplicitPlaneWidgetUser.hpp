/*=========================================================================
  ...
  Module:    vtkImplicitPlaneWidgetUser based on vtkImplicitPlaneWidget.h


  Information of Module vtkImplicitPlaneWidget:
...
//#ifndef vtkImplicitPlaneWidgetUser_hpp
//#define vtkImplicitPlaneWidgetUser_hpp
#pragma once
...
class SLICELIB_API vtkImplicitPlaneWidgetUser : public vtkPolyDataSourceWidget
{
public:
  // Description:
  // Instantiate the object.
  static vtkImplicitPlaneWidgetUser *New();

  vtkTypeMacro(vtkImplicitPlaneWidgetUser,vtkPolyDataSourceWidget);
...
//ETX
  ...
  vtkProperty *MoveNormalProperty;
...
public:
	void SetCouple(SliceCouple*);
	void Calibrate();
	void GoCenter();
	SliceCouple* GetCouple();
private:
...
private:
	...
	// The cut plane is produced with a vtkCutter
	//vtkCutter         *imgCutter;
	//vtkPolyDataMapper *imgCutMapper;
	//vtkActor          *imgCutActor;
	//vtkProperty       *imgPlaneProperty;

private:
  vtkImplicitPlaneWidgetUser(const vtkImplicitPlaneWidgetUser&);  //Not implemented
  void operator=(const vtkImplicitPlaneWidgetUser&);  //Not implemented
};
